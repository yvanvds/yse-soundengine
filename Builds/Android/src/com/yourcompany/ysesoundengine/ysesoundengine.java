...
package com.yourcompany.ysesoundengine;
...
//==============================================================================
public final class ysesoundengine   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ysesoundengine.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ysesoundengine.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            ysesoundengine.this.alertDismissed (callback, 2);
                        }
                    })
