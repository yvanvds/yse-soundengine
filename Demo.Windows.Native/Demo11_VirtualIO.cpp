...
DemoVirtualIO::DemoVirtualIO() {
  ...
  // fill buffermanager
  int f1 = loadToBuffer(YSE_TEST_RESOURCES_DIR "/countdown.ogg", &fileBuffer1);
  int f2 = loadToBuffer(YSE_TEST_RESOURCES_DIR "/contact.ogg", &fileBuffer2);
  int f3 = loadToBuffer(YSE_TEST_RESOURCES_DIR "/flies.ogg", &fileBuffer3);
