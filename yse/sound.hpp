...
namespace YSE {
  ...
  */
  ...
  private:
    ...
    INTERNAL::soundImplementation *pimpl; // the implementation side of this object
    lfQueue<soundMessage> messages; // contains messages read by the soundImplementation (from dsp callback)
