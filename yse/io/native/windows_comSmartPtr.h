...
#ifndef WINDOWS_COMSMARTPTR_H_INCLUDED
#define WINDOWS_COMSMARTPTR_H_INCLUDED
...
inline GUID uuidFromString(const char* const s) noexcept
{
  ...
  GUID g = { p0, (U16)p1, (U16)p2, { (U8)p3, (U8)p4, (U8)p5, (U8)p6,
    (U8)p7, (U8)p8, (U8)p9, (U8)p10 } };
  return g;
}
...
//==============================================================================
#define YSE_COMRESULT  HRESULT __stdcall
...
protected:
  ...
  YSE_COMRESULT QueryInterface(REFIID refId, void** result)
  {
  ...
  template <class Type>
  YSE_COMRESULT castToType(void** result)
  {
...
#endif   // WINDOWS_COMSMARTPTR_H_INCLUDED
