...
namespace YSE {
  ...
  public:
    ...
    /** Create a filebased sound and register it with the soundsystem. Other functions will not work
        ...
        */
    sound& create(const char * fileName, channel * ch = nullptr, bool loop = false, float volume = 1.0f, bool streaming = false);
    ...
    /** Create a sound based on an audiobuffer. This function is useful to play soundfiles which are loaded to
        ...
        0.0 and 1.0. Default is 1.0.
        */
	sound& create(YSE::DSP::buffer & buffer, channel * ch = nullptr, bool loop = false, float volume = 1.f);
    

    /** Small variation of the previous function, but specialized for multichannel sources.
    */
	sound& create(MULTICHANNELBUFFER & buffer, channel * ch = nullptr, bool loop = false, float volume = 1.0f);
    ...
    /** Create a DSP sound and register it with the soundsystem. In contrast to a filebased sound,
        ...
        */
    sound& create(YSE::DSP::dspSourceObject &  dsp, channel * ch = nullptr, float volume = 1.0f);

    /**
      Use a patcher as a sound.
    */
    sound& create(YSE::patcher & patcher, channel * ch = nullptr, float volume = 1.0f);
    ...
    */
    ...
    /**
      ...
      */
    sound& volume(float value, unsigned int time = 0);
    ...
    /**
      ...
      */
    sound& fadeAndStop(unsigned int time);
    ...
    */
    ...
    sound& setDSP(YSE::DSP::dspObject * value); YSE::DSP::dspObject * getDSP(); // attach a dsp object to this sound
