...
CONSTRUCT(), ready(false) {
  ...
  ADD_DESCRIPTION("MIDI device output. Sends raw MIDI byte lists to the selected hardware port; "
                  "understands 'allnotesoff', 'reset', 'omni on/off', 'poly on/off', and 'local "
                  "control on/off' as control messages.");
