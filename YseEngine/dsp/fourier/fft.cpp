...
YSE::DSP::buffer& YSE::DSP::fft::operator()(YSE::DSP::buffer& realIn,
                                            YSE::DSP::buffer& imaginaryIn) {
...
YSE::DSP::buffer& YSE::DSP::inverseFft::operator()(YSE::DSP::buffer& realIn,
                                                   YSE::DSP::buffer& imaginaryIn) {
  if (realIn.getLength() != imaginaryIn.getLength()) {
    assert(false);
  }
...
YSE::DSP::buffer& YSE::DSP::inverseRealFft::operator()(YSE::DSP::buffer& realIn,
                                                       YSE::DSP::buffer& imaginaryIn) {
  if (realIn.getLength() != imaginaryIn.getLength()) {
    assert(false);
  }
