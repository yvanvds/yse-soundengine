...
void addSound() {
  ...
  if (sounds[currentSound]->isValid()) {
    sounds[currentSound]->setPosition(YSE::Vec(YSE::Random(20) - 10, YSE::Random(20) - 10, YSE::Random(20) - 10));
    sounds[currentSound]->play().setVolume(0.1); // it can get very loud with 100's of sounds
  }
  currentSound++;
//#ifdef MAC
