...
int main() {
  ...
  flies.pan2D(true).spread(1.0).play();
  ...
  while (true) {
    if (_kbhit()) {
      ...
      switch (ch) {
      case '0': count.time(11.2f * 44100).pos(YSE::Pos(-5, 0, 0)); break;
      case '1': count.time(10.0f * 44100).pos(YSE::Pos(-4, 0, 0)); break;
      case '2': count.time(9.0f * 44100).pos(YSE::Pos(-3, 0, 0)); break;
      case '3': count.time(8.0f * 44100).pos(YSE::Pos(-2, 0, 0)); break;
      case '4': count.time(6.7f * 44100).pos(YSE::Pos(-1, 0, 0)); break;
      case '5': count.time(5.5f * 44100).pos(YSE::Pos(0, 0, 0)); break;
      case '6': count.time(4.3f * 44100).pos(YSE::Pos(1, 0, 0)); break;
      case '7': count.time(3.2f * 44100).pos(YSE::Pos(2, 0, 0)); break;
      case '8': count.time(2.0f * 44100).pos(YSE::Pos(3, 0, 0)); break;
      case '9': count.time(1.0f * 44100).pos(YSE::Pos(4, 0, 0)); break;
